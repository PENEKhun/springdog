...
public abstract class _Endpoint extends BaseDataObject {
    ...
    public static final StringProperty<String> FQCN = PropertyFactory.createString("fqcn", String.class);
    ...
    public static final ListProperty<EndpointParameter> ENDPOINTPARAMETERS1 = PropertyFactory.createList("endpointparameters1", EndpointParameter.class);
    ...
    public void setFqcn(String fqcn) {
        beforePropertyWrite("fqcn", this.fqcn, fqcn);
        this.fqcn = fqcn;
    }

    public String getFqcn() {
        beforePropertyRead("fqcn");
        return this.fqcn;
    }
    ...
    protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
        super.readState(in);
        this.fqcn = (String)in.readObject();
