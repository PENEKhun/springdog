...
public abstract class _Endpoint extends BaseDataObject {
  ...
  public static final StringProperty<String> HTTP_METHOD =
      PropertyFactory.createString("httpMethod", String.class);
  public static final BaseProperty<Boolean> IS_PATTERN_PATH =
      PropertyFactory.createBase("isPatternPath", Boolean.class);
  public static final StringProperty<String> PATH = PropertyFactory.createString("path", String.class);
  public static final NumericProperty<Integer> RULE_BAN_TIME_IN_SECONDS =
      PropertyFactory.createNumeric("ruleBanTimeInSeconds", Integer.class);
  public static final BaseProperty<Boolean> RULE_IP_BASED =
      PropertyFactory.createBase("ruleIpBased", Boolean.class);
  public static final BaseProperty<Boolean> RULE_PERMANENT_BAN =
      PropertyFactory.createBase("rulePermanentBan", Boolean.class);
  public static final NumericProperty<Integer> RULE_REQUEST_LIMIT_COUNT =
      PropertyFactory.createNumeric("ruleRequestLimitCount", Integer.class);
  public static final StringProperty<String> RULE_STATUS =
      PropertyFactory.createString("ruleStatus", String.class);
  public static final NumericProperty<Integer> RULE_TIME_LIMIT_IN_SECONDS =
      PropertyFactory.createNumeric("ruleTimeLimitInSeconds", Integer.class);
  public static final ListProperty<EndpointParameter> ENDPOINTPARAMETERS =
      PropertyFactory.createList("endpointparameters", EndpointParameter.class);
  public static final ListProperty<EndpointParameter> ENDPOINTPARAMETERS1 =
      PropertyFactory.createList("endpointparameters1", EndpointParameter.class);
  ...
  protected Object endpointparameters1;
  ...
  public void addToEndpointparameters1(EndpointParameter obj) {
    addToManyTarget("endpointparameters1", obj, true);
  }

  public void removeFromEndpointparameters1(EndpointParameter obj) {
    removeToManyTarget("endpointparameters1", obj, true);
  }

  @SuppressWarnings("unchecked")
  public List<EndpointParameter> getEndpointparameters1() {
    return (List<EndpointParameter>) readProperty("endpointparameters1");
  }
  ...
  public Object readPropertyDirectly(String propName) {
    ...
    switch (propName) {
      ...
      case "endpointparameters1":
        return this.endpointparameters1;
      default:
  ...
  public void writePropertyDirectly(String propName, Object val) {
    ...
    switch (propName) {
      ...
      case "httpMethod":
        ...
        break;
      case "isPatternPath":
        this.isPatternPath = val != null && (boolean) val;
        break;
      case "path":
      ...
      case "ruleBanTimeInSeconds":
        ...
        break;
      case "ruleIpBased":
        this.ruleIpBased = val != null && (boolean) val;
        break;
      case "rulePermanentBan":
        this.rulePermanentBan = val != null && (boolean) val;
        break;
      case "ruleRequestLimitCount":
  ...
  protected void writeState(ObjectOutputStream out) throws IOException {
    ...
    out.writeObject(this.endpointparameters1);
  }
  ...
  protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
    ...
    this.endpointparameters1 = in.readObject();
  }
}
