...
public abstract class _EndpointVersionControl extends BaseDataObject {
  ...
  public static final DateProperty<LocalDateTime> DATE_OF_VERSION =
      PropertyFactory.createDate("dateOfVersion", LocalDateTime.class);
  public static final StringProperty<String> FULL_HASH_OF_ENDPOINTS =
      PropertyFactory.createString("fullHashOfEndpoints", String.class);
  public static final ListProperty<EndpointChangelog> ENDPOINTCHANGELOGS =
      PropertyFactory.createList("endpointchangelogs", EndpointChangelog.class);
