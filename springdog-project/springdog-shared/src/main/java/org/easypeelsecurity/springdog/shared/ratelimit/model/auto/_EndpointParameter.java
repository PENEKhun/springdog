...
public abstract class _EndpointParameter extends BaseDataObject {
  ...
  public static final EntityProperty<Endpoint> ENDPOINT =
      PropertyFactory.createEntity("endpoint", Endpoint.class);
  public static final ListProperty<Endpoint> ENDPOINTS =
      PropertyFactory.createList("endpoints", Endpoint.class);
  ...
  public void writePropertyDirectly(String propName, Object val) {
    ...
    switch (propName) {
      case "enabled":
        this.enabled = val != null && (boolean) val;
        break;
      case "hash":
