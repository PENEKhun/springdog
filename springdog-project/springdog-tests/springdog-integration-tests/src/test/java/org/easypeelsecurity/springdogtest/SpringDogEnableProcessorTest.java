...
class SpringDogEnableProcessorTest {
  ...
  @ValueSource(strings = {"springdogRepository",
      "springdogAgentView", "springdogAgentSecurityApplier", "springdogSecurityFilterChain", "springdogSecurityConfig", "springDogDynamicTemplateResolver",
      "springdogAutoconfigurationBeanApplier", "springdogBannerPrinter", "springdogManagerApplier",
      "springdogProperties"})
