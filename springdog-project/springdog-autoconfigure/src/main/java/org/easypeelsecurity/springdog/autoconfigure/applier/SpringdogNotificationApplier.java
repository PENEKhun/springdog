 ...
 */
public class SpringdogNotificationApplier extends CodeGenerator {

  @Override
  public Builder typeSpec() {
    return TypeSpec.classBuilder("SpringdogNotificationApplier")
        .addAnnotation(Configuration.class)
        .addAnnotation(AnnotationSpec.builder(ComponentScan.class)
            .addMember("basePackages", "$S", "org.easypeelsecurity.springdog.notification")
            .build())
