 ...
 */
public class SpringdogDomainApplier extends CodeGenerator {

  @Override
  public Builder typeSpec() {
    return TypeSpec.classBuilder("SpringdogDomainApplier")
        .addAnnotation(Configuration.class)
        .addAnnotation(AnnotationSpec.builder(ComponentScan.class)
            .addMember("basePackages", "$S", "org.easypeelsecurity.springdog.domain")
            .build())
